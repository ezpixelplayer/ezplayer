...
Follow the [show scheduling instructions](./getting-started-local.md#4-schedule-the-show).

## Where to next

- [What is EZPlayer](../introduction/what-is-ezplayer.md) — how EZPlayer fits in with your show.
