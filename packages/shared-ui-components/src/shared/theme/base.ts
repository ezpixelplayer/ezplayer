...
import { IndexnineTheme } from './schemes/IndexnineTheme';
...
export interface ThemeOptionsExtensions {
    colors: {
        gradients: {
            blue1: string;
            blue2: string;
...
declare module '@mui/material/styles' {
    ...
    // eslint-disable-next-line @typescript-eslint/no-empty-object-type
    interface ThemeOptions extends Partial<ThemeOptionsExtensions> {}
}

export interface ExtendedTheme extends Theme, ThemeExtensions {}
export interface ExtendedThemeOptions extends ThemeOptions, Partial<ThemeOptionsExtensions> {}
