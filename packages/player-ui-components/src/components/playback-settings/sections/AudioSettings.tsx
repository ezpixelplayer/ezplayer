        ...
        <Box>
            ...
            <Box sx={{ mt: 1 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                    ...
                    LUFS). The original audio file is never changed; the normalized copy lives in the show folder cache.
                    Cloud songs already arrive normalized. Change it per song in Edit Song.
                </Typography>
            </Box>
