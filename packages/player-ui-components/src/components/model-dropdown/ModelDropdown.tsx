...
export const ModelDropdown: React.FC<ModelDropdownProps> = ({
    ...
    return (
        <div ref={dropdownRef} className={`model-dropdown ${className} ${disabled ? 'model-dropdown--disabled' : ''}`}>
            <button
                type="button"
            ...
            {isOpen && (
                <div className="model-dropdown__list-container" style={{ maxHeight: `${maxHeight}px` }} role="listbox">
