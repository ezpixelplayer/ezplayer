...
// 🟢 Example extracted colors from DaisyUI "luxury" theme (adjust as needed)
const luxuryThemeColors = {
    'color-scheme': 'dark',
...
const ezrgbColors = {
    ...luxuryThemeColors,
    primary: '#CF9F4D', // Daisy uses #dca54c Zach uses #CF9F4D
    secondary: '#FFE7A3',
    black: '#CF9F4D', // aka base-content
    white: '#09090b', // aka base-100
    primaryAlt: '#171618', // Dark color
    trueWhite: '#ffffff',
    backgroundColor: '#171618',
};

// 🟣 Convert DaisyUI Theme to MUI Theme
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function createMuiThemeFromDaisy(daisyUITheme: any) {
    return createTheme({
        palette: {
            primary: { main: daisyUITheme.primary },
            secondary: { main: daisyUITheme.secondary },
            background: { default: daisyUITheme.base100 },
            text: { primary: '#FFFFFF', secondary: '#D1C4E9' }, // Adjust for readability
            error: { main: daisyUITheme.error },
            warning: { main: daisyUITheme.warning },
            success: { main: daisyUITheme.success },
            info: { main: daisyUITheme.info },
        },
        typography: {
            fontFamily: `"var(--font-geist-sans)", Inter, sans-serif`, // Match Tailwind config
        ...
        components: {
            MuiButton: {
                styleOverrides: {
                    root: {
                        borderRadius: '8px', // Matches DaisyUI button styles
            ...
            MuiTextField: {
                styleOverrides: {
                    root: {
                        borderRadius: '8px',
                        backgroundColor: daisyUITheme.base100,
                        '& .MuiInputBase-root': {
                            color: '#FFFFFF',
                        },
                    },
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function createColors(themeColors: any) {
    return {
        gradients: {
        ...
        layout: {
            general: {
                bodyBg: themeColors.backgroundColor,
            },
            sidebar: {
                ...
                menuItemBgActive: alpha(themeColors.primaryAlt, 0.6),
                menuItemIconColor: themeColors.primary,
                menuItemIconColorActive: lighten(themeColors.primary, 0.3),
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function createMuiExtendedTheme(colors: any, themeColors: any) {
    return createTheme({
        // direction: i18n.dir(),
        colors: {
            gradients: {
        ...
        components: {
            MuiBackdrop: {
                styleOverrides: {
                    root: {
                        backgroundColor: alpha(darken(themeColors.backgroundColor, 0.5), 0.4),
                ...
                styleOverrides: {
                    ...
                    '&.HeaderWrapperDarkTheme': {
                        boxShadow: `0 1px 0 ${alpha(
                            darken(colors.primary.main, 0.7),
                            0.15,
                    ...
                    '&.MuiPageTitlewrapperDark': {
                        '.MuiPageTitle-wrapper': {
                            background: colors.alpha.trueWhite[5],
                            marginBottom: 28,
                            boxShadow: `0 1px 0 ${alpha(
                                darken(colors.primary.main, 0.7),
                                0.15,
            ...
            MuiTypography: {
                ...
                styleOverrides: {
                    root: {
                        ...
                        '&.UserBoxDescription': {
                            color: darken(colors.secondary.main, 0.5),
                        },
                        '&.SearchTypography': {
                            color: darken(colors.secondary.main, 0.5),
                        },
...
export const ezrgbThemeSimple = createMuiThemeFromDaisy(ezrgbColors);
export const ezrgbTheme = createMuiExtendedTheme(createColors(ezrgbColors), ezrgbColors);
